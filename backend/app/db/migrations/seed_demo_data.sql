...
-- Description: Seed initial demo merchants, rules configs, sample transactions, and hash-chained audit logs.

-- Demo Merchant A (e.g. Acme Payments)
...
-- Demo Merchant B (e.g. Nova Retail)
INSERT INTO merchants (id, name, api_key_hash, created_at)
VALUES (
